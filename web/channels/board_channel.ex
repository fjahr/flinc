defmodule Flinc.BoardChannel do
  @moduledoc """
  Board channel
  """

  use Flinc.Web, :channel

  alias Flinc.{User, Board, UserBoard, List, Card, Comment, CardMember}
    ...
    try do
      ...
      case Repo.insert(changeset) do
        {:ok, _board_user} ->
          ...
          Flinc.Endpoint.broadcast_from! self(), "users:#{user.id}", "boards:add", %{board: board}
